                        ...
                        Expanded(
                          child: TextField(
                            decoration: InputDecoration(
                                hintText: 'Kamu bisa ubah alamatnya sewaktu-waktu loh',
                ...
                Expanded(
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      //Text(data)
                          Text('Jl. Melati No. 45, RT 03/RW 05, Kelurahan Kebon Jeruk,',
                            style: TextStyle(
                              color: Color(0xFF6B6969),
                              fontSize: 12,
                            ),
                      ...
                      Row(
                        children: <Widget>[
                          ...
                          Text('Kota Jakarta Barat, Provinsi DKI Jakarta.',
                            style: TextStyle(
                              color: Color(0xFF6B6969),
                              fontSize: 12,
                            ),
